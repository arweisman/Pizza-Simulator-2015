...
void pineapple(int pinex, int piney) {
  fill(255, 255, 0);
  quad(pinex, piney, pinex+random(20, 50), piney, pinex+random(20, 50), piney+random(20, 50), pinex, piney+random(20, 50));
}
//onions
void onion(int onix, int oniy) {
  ...
  strokeWeight(7);
  stroke(214, 108, 191);
  ellipse(onix, oniy, 65+onionran, 65+onionran);
  stroke(255);
  strokeWeight(5);
  ellipse(onix, oniy, 55+onionran, 55+onionran);
}
//olives
